...
Since you need to submit a CodeSandbox link with your response (_See [r](#submission)_), we recommend that you create the CodeSandbox first, solve the bugs in your generated CodeSandbox, and then share the link with us. _You can also work locally first, and upload at the end._
...
_Reference: https://conpm stardesandbox.io/docs/importing#import-local-projects-via-cli_
